...
sub = df.filter(df.site == "Barack_Obama")  # not sure how to get filter to work with regular expression operations
counts = sub.groupBy(['date','hour','lang']).count()  # .collect ???
